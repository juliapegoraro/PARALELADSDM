				...
				case 3:
					...
					if (!imoveis.isEmpty()) {
						...
						for (int i = 0; i < imoveis.size(); i++) {
							...
							if (imoveis.get(i) instanceof Apartamento) {
								
								System.out.println("Tipo da propriedade: APARTAMENTO\n");
							...
							else if (imoveis.get(i) instanceof Condominio) {

								System.out.println("Tipo da propriedade: CASA EM CONDOMINIO\n");
								System.out.println("Proprietario: " + imoveis.get(i).getProprietario());
								System.out.println("Endereco: " + imoveis.get(i).getEndereco());
								System.out.println("Tamanho: " + imoveis.get(i).getMetros());
								System.out.println("\n");
							...
							else if (imoveis.get(i) instanceof Comercial) {
								
								System.out.println("Tipo da propriedade: IMOVEL COMERCIAL\n");
								System.out.println("Proprietario: " + imoveis.get(i).getProprietario());
								System.out.println("Endereco: " + imoveis.get(i).getEndereco());
								System.out.println("Tamanho: " + imoveis.get(i).getMetros());
								System.out.println("\n");
							...
							else if (imoveis.get(i) instanceof Casa) {
								System.out.println("Tipo da propriedade: CASA\n");
								System.out.println("Proprietario: " + imoveis.get(i).getProprietario());
								System.out.println("Endereco: " + imoveis.get(i).getEndereco());
								System.out.println("Tamanho: " + imoveis.get(i).getMetros());
								System.out.println("\n");
